    ...
    <RegisterFormBlock>
      ...
      <div className="register__content">
        ...
        <div className="textArea">
          ...
          <br />
          <br />
          이 약관은 51PERCENT 회사(전자거래 사업자)가 운영하는 51PERCENT 사이버
          몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라
          한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을
          규정함을 목적으로 합니다.
          <br />
          ...
          <br />
          <br />
          ① "몰"이란 51PERCENT 회사가 재화 또는 용역을 이용자에게 제공하기
          위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수
          ...
          "몰"의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은
          ...
          공정거래위원회가 정하는 전자상거래 등에서의 소비자보호지침 및 관계법령
          또는 상관례에 따릅니다.
          <br />
          <br />
          <br />
          ...
          의하여 구매를 신청하며, "몰"은 이용자가 구매신청을 함에 있어서 다음의
          각 내용을 알기 쉽게 제공하여야 합니다. 단, 회원인 경우 제2호 내지
          제4호의 적용을 제외할 수 있습니다.
          <br />
          1. 재화등의 검색 및 선택
          <br />
          ...
          다음 각호의 방법중 가용한 방법으로 할 수 있습니다. 단, "몰"은 이용자의
          ...
          <br />
          <br />
          ① "몰"은 이용자와 재화등의 공급시기에 관하여 별도의 약정이 없는 이상,
          ...
          제공할 수 없으며, 이에 대한 모든 책임은 몰이 집니다. 다만, 다음의
          경우에는 예외로 합니다.
          <br />
          ...
          <br />
          <br />
          ① 상위 "몰"과 하위 "몰"이 하이퍼 링크(예: 하이퍼 링크의 대상에는 문자,
        ...
        <table className="register__content__table">
          <thead>
            <tr>
              <th>선택</th>
              <th>주문/결제 및 배송서비스</th>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <br />
                - 수집항목 : 구매자정보, 상품 구매/취소/반품/교환/환불 정보,
                수령인 정보
                <br />- 보유/이용기간 : 회원탈퇴 후 5일까지
              </td>
            </tr>
          </tbody>
        </table>
